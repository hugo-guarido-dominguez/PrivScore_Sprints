...
// Encuentra enlaces a polÃ­tica de privacidad / cookies / tÃ©rminos y recoge seÃ±ales tÃ©cnicas del DOM.
...
(function () {
  ...
  const KEYWORDS = [
    // Privacidad
    "privacy", "privacidad", "privacy policy", "polÃ­tica de privacidad", "politica de privacidad",
    // Cookies
    "cookies", "cookie policy", "polÃ­tica de cookies", "politica de cookies",
    // TÃ©rminos / legal
    "terms", "tÃ©rminos", "terminos", "terms of service", "terms & conditions",
    "condiciones", "condiciones de uso", "aviso legal", "legal", "legal notice", "imprint"
  ];

  const STRONG = [
    "privacy", "privacidad", "cookies", "cookie policy", "polÃ­tica de privacidad", "polÃ­tica de cookies",
    "terms", "tÃ©rminos", "aviso legal"
  ];
...
// Developep by @marichu_kt
  ...
  function detectConsent() {
    ...
    // HeurÃ­stica DOM: contenedores tÃ­picos
