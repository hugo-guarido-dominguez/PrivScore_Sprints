 ...
 * - persistentCookies
 * - sessionCookies
 * - thirdPartyCookies (estimaciÃ³n por dominio)
 * - maxExpirationDays
 * - topDomains
...
export async function getCookiesSummaryFromUrl(tabUrl) {
  ...
  // Nota: esto NO incluye necesariamente cookies â€œde tercerosâ€ asociadas a otros dominios.
  ...
  // Nota: esto es una aproximaciÃ³n, porque la API no te dice â€œquiÃ©n la pusoâ€.
